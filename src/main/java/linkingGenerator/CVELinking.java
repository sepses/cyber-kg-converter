...
public class CVELinking {
	...
	public static Model generateLinking(Model CVEModel, Model CPEModel, Model CWEModel, String fileName) throws IOException {
			...
			//generate filter for CWE query	 
			 Query sidQ3 = QueryFactory.create(sidQuery3);
			    ...
			    String nolinking_cve_cpe = ""; 
					  ...
					  if (CPEResArray.contains(lista)) {
						  ...
						  resS.addProperty(hasCPE,resO);
						   // System.out.println(CWERes2.toString()+" "+lista);
							...
							//System.out.println(CWECAPEC2.toString()+" has no linking !! ");  
						}
				 ...
				 String fileNameNL = "output/linking/CVETOCPE_"+fileName+"_NoLinking.log";
				 String fileNameNL2 = "output/linking/CVETOCWE_"+fileName+"_NoLinking.log";
