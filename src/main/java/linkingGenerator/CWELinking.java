		...
		//find the linking, if it exists generate linking otherwise make a log
			...
			QueryExecution sidQex = QueryExecutionFactory.create(sidQ, CWEModel);
			 ...
			 System.out.println(filterStatement);System.exit(0);
			 	...
			 	ArrayList<String>[] CAPECResArray = getCAPECResourceFilterStatement(filterStatement+"?capecId = \"0\"", CAPECModel);
			    ...
			    while (sidQResult2.hasNext()) {
					 ...
					 while(CAPECResArray[1].size() > i) {	 	
					   ...
					   if (CAPECResArray[1].get(i).equals(CWECAPEC2.toString().substring(4))) {
						  ...
						  CAPECfound++;
						  System.out.println("CAPEC Found, generate linking "+CWERes2.toString()+"to "+CAPECResArray[0].get(i));
					...
					//  System.exit(0);
					 ...
					 if(CAPECfound < 1) {
						  ...
						  System.out.println("CAPEC Not Found, generate No linking "+CWERes2.toString()+"to "+CWECAPEC2.toString());
					   CAPECNotFound++;  
					 }else {
					   CAPECFound++;
					 }
				 ...
				 System.out.println("CAPEC Found :"+CAPECFound+", CAPEC Not Found : "+CAPECNotFound);
				    //System.exit(0);
							 ...
							 String fileNameNL = "output/linking/CWETOCAPEC_"+fileName+"_NoLinking.log.ttl";
