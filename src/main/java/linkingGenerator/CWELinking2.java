...
public class CWELinking2 {
	
	
	public static Model generateLinking(Model CWEModel,  String CyberKnowledgeEp, String CAPECGraphName, String fileName, String outputDir) throws IOException {
		...
		//System.out.println(CAPECResArray[0].size());System.exit(0);
			...
			String sidQuery = "select ?s where {\r\n" + 
			    ...
			    while (sidQResult.hasNext()) {
					 ...
					 while (QResult2.hasNext()) {
						 ...
						 System.out.println("CAPEC Found :"+capecFound+", CAPEC Not Found : "+capecNotFound+", CAPEC Given :"+capecGiven);
							
			 }
				  			 String fileNameNL = outputDir+"/linking/CWETOCAPEC_"+fileName+"_NoLinking.log.ttl";
