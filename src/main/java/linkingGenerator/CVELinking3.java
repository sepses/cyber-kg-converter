...
public class CVELinking3 {
	
	

	
	
	public static Model generateLinkingCVETOCPE(Model CVEModel, String CyberKnowledgeEp , String CPEGraphName, String fileName, String outputDir) throws IOException {
		...
		//end of generating CVE to CPE
					//generating CVE to Vulnerability Configuration
						...
						// System.out.println(Query3);System.exit(0);
						 ...
						 Property hasLogicalTestFactRef = linkingModelCVECPE.createProperty("http://w3id.org/sepses/vocab/ref/cpe#hasLogicalTestFactRef"); 
						 Property hasLogicalTest = linkingModelCVECPE.createProperty("http://w3id.org/sepses/vocab/ref/cpe#hasLogicalTest"); 
						 Property logicalTestOperator = linkingModelCVECPE.createProperty("http://w3id.org/sepses/vocab/ref/cpe#logicalTestOperator"); 
						 Property logicalTestNegate = linkingModelCVECPE.createProperty("http://w3id.org/sepses/vocab/ref/cpe#logicalTestNegate"); 
						 Property hasVulnerableConfiguration = linkingModelCVECPE.createProperty("http://w3id.org/sepses/vocab/ref/cve#hasVulnerableConfiguration");
						 Property hasNoLogicalTestFactRef = linkingModelCVECPE.createProperty("http://w3id.org/sepses/vocab/ref/cpe#hasNoLogicalTestFactRef"); 
						 int frGiven =0;	
						 int frFound = 0;
						 int frNotFound = 0;
							 ...
							 if(foundCPE.contains(cpeId.toString())) {
								// System.out.println("found in local!");
								 ...
								 Resource resCVE = linkingModelCVECPE.createResource(cveId.toString());
							       ...
							       Resource resO = linkingModelCVECPE.createResource(foundCPERes.get(keyFoundCPE));
							       Resource LogicalTest = linkingModelCVECPE.createResource("http://w3id.org/sepses/vocab/ref/cpe#LogicalTest");
								 ...
								 //check in CPEArrayOfList 
									 if(CPEArrayofList[1].contains(cpeId.toString())) {
										 ...
										 Resource resSn = NolinkingModelCVECPE.createResource(vc.toString());
										  Resource LogicalTestN = NolinkingModelCVECPE.createResource("http://w3id.org/sepses/vocab/ref/cpe#LogicalTest");
			 ...
			 System.out.println(cveId+ " CPE found= "+cpeFound+" & CPE Not Found="+cpeNotFound+" , given CPE="+(cpeGiven));
			 System.out.println(cveId+ " CPEfr found= "+frFound+" & CPEfr Not Found="+frNotFound+" , given CPEfr="+(frGiven));
			 System.out.println(cveId+ " CPEfr2 found= "+fr2Found+" & Ffr2 Not Found="+fr2NotFound+" ,given CPEfr2="+(fr2Given));
		 ...
		 String fileNameNL = outputDir+"/linking/CVETOCPE_"+fileName+currentDate+"_NoLinking.log.ttl";
...
public static Model generateLinkingCVETOCWE(Model CVEModel, String CyberKnowledgeEp, String CWEGraphName, String fileName, String outputDir) throws IOException {
	...
	String CWEQuery = "select ?s ?cweId where { \r\n" + 
	  ...
	  //  String nolinking_cve_cwe = ""; 
	    ...
	    //System.exit(0);
	    		...
	    		String currentDate =  new SimpleDateFormat("yyyyMMddHHmm").format(new Date());
				 ...
				 String fileNameNL = outputDir+"/linking/CVETOCWE_"+fileName+currentDate+"_NoLinking.log.ttl";
			       // FileWriter rdfLingking = new FileWriter(fileName);
