...
public class CsvParser {
    ...
    public static org.apache.jena.rdf.model.Model Parse(String csvFileName) throws IOException {
        // load RML file and all supporting functions
        InputStream is = CsvParser.class.getClassLoader().getResourceAsStream("rml/minerful-csv.rml");
