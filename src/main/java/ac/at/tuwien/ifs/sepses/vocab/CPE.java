...
public class CPE {
    ...
    public static final Property HAS_VENDOR = m_model.createProperty( "http://w3id.org/sepses/vocab/ref/cpe#hasVendor" );
    ...
    public static final Property PRODUCT_NAME = m_model.createProperty( "http://w3id.org/sepses/vocab/ref/cpe#productName" );
    
    public static final Property SOFTWARE_EDITION = m_model.createProperty( "http://w3id.org/sepses/vocab/ref/cpe#softwareEdition" );
    
    public static final Property TARGET_HARDWARE = m_model.createProperty( "http://w3id.org/sepses/vocab/ref/cpe#targetHardware" );
    
    public static final Property TARGET_SOFTWARE = m_model.createProperty( "http://w3id.org/sepses/vocab/ref/cpe#targetSoftware" );
    ...
    public static final Resource LOGICAL_TEST = m_model.createResource( "http://w3id.org/sepses/vocab/ref/cpe#LogicalTest" );
