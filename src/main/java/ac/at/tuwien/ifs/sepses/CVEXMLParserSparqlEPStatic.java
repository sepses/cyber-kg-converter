...
public class CVEXMLParserSparqlEPStatic {
    ...
    public static void parseCVE(String CVEXMLFile, String RMLFile, String RDFOutput, String CyberKnowledgeEp,
            String CWEGraphName, String CPEGraphName, String outputDir) throws Exception {
